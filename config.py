...
# recién retomó. El calendario post-reanudación puede tener huecos, así que
# ampliamos la ventana a 10 días para no quedarnos sin partidos por una
# coincidencia de fechas. Se puede volver a 5 más adelante si hace falta.
LOOKAHEAD_DAYS = 10
